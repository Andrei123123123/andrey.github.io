...
const advantages = [
  ...
  },
  {
    ...
    description:
      "Всё включено — от билетов до завтраков. Помогаем подобрать рейсы, бронируем комфортное жильё рядом с академией и организуем питание на весь период. Ты просто приезжаешь.",
    features: [
  ...
  },
  {
    ...
    description:
      "Камерная группа из 12 человек, где каждый находит единомышленников. Совместные тренировки, приключения на острове и вечера формируют связи, которые остаются надолго после кемпа.",
    features: [
      "Малая группа — максимум 12 участников",

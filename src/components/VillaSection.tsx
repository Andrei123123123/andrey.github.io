...
const villaImages = [
  ...
  { src: bedroom4, alt: "Спальня на вилле" },
  { src: bathroom1, alt: "Джакузи в люкс-сюите" },
  { src: bathroom2, alt: "Ванная комната на вилле" },
  { src: bathroom3, alt: "Ванная комната на вилле" },
  { src: bbq, alt: "Зона барбекю" },
  { src: extra1, alt: "Интерьер виллы" },
  { src: extra2, alt: "Турецкая баня (хамам) с мозаикой" },
  { src: extra3, alt: "Интерьер виллы" },
  { src: extra4, alt: "Большой обеденный стол под навесом" },
  { src: extra5, alt: "Интерьер виллы" },
  { src: extra6, alt: "Интерьер виллы" },
  { src: extra7, alt: "Интерьер виллы" },
  { src: extra8, alt: "Интерьер виллы" },
  { src: extra9, alt: "Вид на виллу" },
];

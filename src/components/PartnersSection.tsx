        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="reveal bg-card rounded-xl p-8 lg:p-10 border border-border hover:shadow-xl transition-shadow duration-300 flex flex-col">
            <div className="flex items-center gap-4 mb-5">
              ...
              <div>
                <h3 className="font-display text-[20px] font-semibold text-forest">ВизаGO</h3>
                <p className="text-[12px] text-text-muted-custom">Визовый оператор · Турагент кемпа</p>
              </div>
            </div>

            <p className="text-[14px] text-text-body leading-[1.7] mb-6">
            ...
            <div className="grid grid-cols-3 gap-3 mb-6 py-4 border-y border-border">
              <div className="text-center">
                <p className="font-display text-[20px] font-semibold text-forest">500+</p>
                <p className="text-[11px] text-text-muted-custom mt-0.5">виз оформлено</p>
              </div>
              <div className="text-center">
                <p className="font-display text-[20px] font-semibold text-forest">97%</p>
                <p className="text-[11px] text-text-muted-custom mt-0.5">одобрение шенгена</p>
              </div>
              <div className="text-center">
                <p className="font-display text-[20px] font-semibold text-forest">24/7</p>
                <p className="text-[11px] text-text-muted-custom mt-0.5">на связи в Telegram</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3 mb-6">
              {[
                ...
                <div key={i} className="flex items-start gap-2">
                  ...
                  <span className="text-[13px] text-text-body leading-[1.5]">{item}</span>
                </div>
              ))}
            </div>
            ...
            <div className="flex items-center justify-between mt-auto pt-4">
              <a
                ...
                className="inline-flex items-center gap-2 text-gold text-[13px] font-semibold tracking-[1px] hover:text-gold-light transition-colors no-underline"
              >
                vizago.ru →
              </a>
              <span className="text-[12px] text-text-muted-custom border border-border rounded-full px-3 py-1">Официальный партнёр</span>
            </div>
          </div>
          ...
          <div className="reveal bg-card rounded-xl p-8 lg:p-10 border border-border hover:shadow-xl transition-shadow duration-300 flex flex-col">
            <div className="flex items-center gap-4 mb-5">
              ...
              <div>
                <h3 className="font-display text-[20px] font-semibold text-forest">Tenerife Tennis Academy</h3>
                <p className="text-[12px] text-text-muted-custom">Теннисная академия</p>
              </div>
            </div>
            <p className="text-[14px] text-text-body leading-[1.7] mb-6">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 text-gold text-[13px] font-semibold tracking-[1px] hover:text-gold-light transition-colors no-underline mt-auto"
            >

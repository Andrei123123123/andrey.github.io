    ...
    <section ref={ref} className="bg-sand-light py-24 lg:py-32 px-6 lg:px-16" id="trainer">
      <div className="max-w-[1200px] mx-auto">
        ...
        <p className="reveal max-w-[760px] mb-16 rounded-r-xl border-l-2 border-gold bg-card/45 py-5 pl-6 pr-5 text-[19px] lg:text-[21px] text-forest/85 leading-[1.75] shadow-sm">
          Идея простая: взять всё лучшее из отпуска и добавить теннис. Или наоборот — взять теннис и добавить океан, вулкан, яхту и повара, который готовит национальные блюда каждый день. Мы собрали кемп, в который хотели бы поехать сами. Канарские острова, октябрь, четырнадцать мест и вилла у моря.
        </p>

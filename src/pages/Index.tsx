            ...
            <div>
              ...
              <ul className="animate-fade-up mt-10 grid grid-cols-1 sm:grid-cols-2 gap-3 max-w-[600px] list-none" style={{ animationDelay: "0.22s" }}>
                {[
                  {
                    title: "Виза под ключ",
                    desc: "Индивидуальное приглашение от академии, помощь с документами и подачей",
                    href: "#faq",
                  },
                  {
                    title: "Всё включено",
      ...
      <section className="bg-cream py-24 lg:py-32 px-6 lg:px-16" id="programme">
        <div className="max-w-[1200px] mx-auto">
          ...
          <p className="reveal text-[17px] text-text-body leading-[1.7] mb-14 max-w-[650px]">
            Каждый день — новый маршрут утром и тренировка вечером. 6 тренировок × 1,5 часа = 9 часов на корте за неделю.
          </p>
      ...
      <section className="relative py-24 lg:py-32 px-6 lg:px-16 overflow-hidden" id="pricing">
        ...
        <div className="relative z-10 max-w-[1200px] mx-auto">
          ...
          <p className="reveal text-[17px] text-text-body/80 leading-[1.7] mb-10 max-w-[680px]">
            Спортивная часть — фиксированная стоимость €1250. Перелёт, виза и проживание оформляются отдельно через нашего турагента — итоговая поездка <span className="text-forest font-semibold">от ~285 000 ₽</span> из Москвы.
          </p>

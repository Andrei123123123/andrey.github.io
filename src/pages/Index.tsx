...
const Index = () => {
  ...
  const faqs = [
    { q: "Для какого уровня тенниса подходит кемп?", a: "Подходит для любителей с разным уровнем подготовки — от начинающих до опытных. При необходимости участники делятся по уровню." },
    { q: "Что входит в стоимость €1950?", a: "Участие в кемпе, трансфер, ежедневные тренировки теннис / падел, аренда кортов и оборудования, активности на каждый день, проживание на вилле с поваром и организационное сопровождение." },
    ...
    { q: "Как забронировать место?", a: "Оставьте заявку через форму или напишите нам в мессенджере. Мы свяжемся, подтвердим детали и согласуем оплату обязательного пакета: кемп + проживание." },
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8">
            ...
            <div className="reveal p-8 lg:p-10 bg-forest text-sand-light rounded-2xl border border-gold/25">
              ...
              <h3 className="font-display text-[24px] mb-7 leading-tight">Неделя на Тенерифе под ключ</h3>
            ...
            <div className="reveal p-8 lg:p-10 bg-card border border-forest/10 rounded-2xl">
              ...
              <ul className="flex flex-col gap-3.5 list-none">
                {[
                  ["Авиабилеты", "ориентир €900 при 1 пересадке"],

...
const Index = () => {
  ...
  const faqs = [
    ...
    { q: "Что входит в стоимость €1950?", a: "Участие в кемпе, трансфер, ежедневные тренировки и игровые сессии, корты, активности на каждый день, проживание на вилле с поваром и организационное сопровождение." },

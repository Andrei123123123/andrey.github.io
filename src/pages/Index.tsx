...
const Index = () => {
  ...
  const days = [
    ...
    { d: "20", wd: "Вт", title: "Финал и винодельня", preview: "Финальный турнир, награждение и закрытый ужин на винодельне Bodegas Reverón.", tags: ["Tournament", "Wine"], activities: ["Финальный турнир среди участников", "Награждение и итоги недели", "Закрытый ужин на винодельне Bodegas Reverón", "Дегустация локальных вин и трансфер в аэропорт"], img: day20 },
  ];

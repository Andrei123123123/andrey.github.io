...
const Index = () => {
  ...
  const days = [
    ...
    { d: "20", wd: "Вт", title: "Финал на винодельне Bodegas Reverón", preview: "Утром — дружеский турнир и награждение. Вечером — закрытый ужин для группы на семейной винодельне в горах юга Тенерифе. Локальная кухня, авторская подача, дегустация вин с вулканических террас. Тихое, европейское завершение недели.", tags: ["Tournament", "Wine"], activities: ["Финальный дружеский турнир среди участников", "Награждение и итоги недели", "Закрытый ужин на винодельне Bodegas Reverón", "Дегустация вин с вулканических террас", "Трансфер в аэропорт"], img: day20 },
  ];

...
const Index = () => {
  ...
  const days = [
    { d: "14", wd: "Пн", title: "Прилёт и знакомство", preview: "Трансфер из аэропорта, заселение на виллу у океана. Вечером — первый ужин и знакомство с группой", tags: ["Трансфер", "Ужин", "Тренировка"], activities: ["Встреча в аэропорту TFS, трансфер на виллу", "Заселение, отдых, пляж", "Знакомство группы за ужином", "Первая вечерняя тренировка — разминка и оценка уровня"], img: day14 },

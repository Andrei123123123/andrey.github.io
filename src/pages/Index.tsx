...
const Index = () => {
  ...
  const faqs = [
    ...
    { q: "Включён ли перелёт?", a: "Нет, перелёт бронируется через турпакет (200 000 ₽) или самостоятельно. Аэропорт — Тенерифе Юг (TFS), ~9 часов из Москвы с пересадкой." },
  ...
  const days = [
    ...
    { d: "15", wd: "Вт", title: "Санта-Крус + Loro Parque", preview: "Loro Parque с его дельфинами и косатками, столица острова Санта-Крус и Ботанический сад. Вечером — техника ударов.", tags: ["Loro Parque", "Столица", "Техника"], activities: ["Loro Parque — один из лучших зоопарков мира", "Прогулка по Санта-Крус-де-Тенерифе — столице острова", "Ботанический сад в Пуэрто-де-ла-Крус", "Вечерняя тренировка: работа над техникой ударов"], img: day15 },
      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 py-4 px-6 lg:px-16 flex justify-between items-center transition-all duration-300 ${navScrolled ? "bg-forest/95 backdrop-blur-md shadow-lg" : ""}`}>
        ...
        <div className="hidden md:flex items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <a href="https://vk.com/" target="_blank" rel="noopener noreferrer" className="text-sand/60 hover:text-gold transition-colors" aria-label="VK">
      ...
      <footer className="bg-[hsl(137,22%,8%)] py-12 px-6 lg:px-16">
        <div className="max-w-[1200px] mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex items-center justify-center gap-6">
            ...
            <a href="https://vk.com/" target="_blank" rel="noopener noreferrer" className="text-sand/40 hover:text-gold transition-colors" aria-label="VK">

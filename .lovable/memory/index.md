Tennis + padel camp landing page — design system: forest green + gold + cream/sand palette. Font: display + body. Russian language site.
...
1. Hero (lifestyle positioning + padel)
2. "Это не кемп" (emotional hook)
3. "Почему это работает" (3 cards)
4. "Для кого" (target audience)
5. "Что входит" (4 categories)
6. Trainer section
7. Programme (day by day)
8. Format (numbers + sport/tour packages)
9. Location (Tenerife facts)
10. Advantages
11. Testimonials
12. Pricing (2 packages: sport + tour)
13. Four steps to camp
14. FAQ
15. CTA form + Telegram
16. Footer

## Needs from user
- Real photos (courts, trainer, participants, Tenerife)
- Trainer info (name, photo, experience)
- Instagram link (currently placeholder)
